    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <!-- <?php echo anchor(site_url('tb_siswa/create'),'Create', 'class="btn btn-primary"'); ?> -->
            </div>
		...
		<!-- <th>Action</th> -->
			...
			<!-- <td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('tb_siswa/read/'.$tb_siswa->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('tb_siswa/update/'.$tb_siswa->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('tb_siswa/delete/'.$tb_siswa->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td> -->
		</tr>
                <?php
