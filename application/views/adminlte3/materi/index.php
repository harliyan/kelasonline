...
<div class="page-header row no-gutters py-4">
  <div class="col-12 col-sm-12 text-center text-sm-left mb-0">
    ...
    <h1 class="page-title">INPUT MATERI</h1>
  </div>
</div>
<!-- End Page Header -->
...
<div class="row">
  <div class="col-lg-6">
    <div class="card mb-4">
      <div class="card-body">
        <button type="button" data-toggle="modal" data-target="#tambah-data" class="btn btn-info" class="glyphicon glyphicon-repeat">Tambah Materi dan Deskripsi</button>
      </div>
    </div>
  </div>
<div class="row">
         ...
         <table id="example2" class="table table-bordered table-striped" style="width:auto">
          ...
          <tbody>
            ...
            <tr>
              ...
              <!--   <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/input_sambutan/edit/<?php echo $data->id ?>">Edit</a> -->
                <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/materi/hapus/<?php echo $data->id ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
              </td>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('admin/materi/tambah_aksi')?>" method="post" enctype="multipart/form-data" role="form">
          <div class="modal-body">
            ...
            <div>
             <label for="exampleFormControlInput1">Upload File Materi (Doc/Pdf Max 2MB)</label>
           </div>
           <div class="form-group">
