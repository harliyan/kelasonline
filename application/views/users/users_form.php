...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            <label for="varchar">Privilege <?php echo form_error('privilege') ?></label>
            <input type="text" class="form-control" name="privilege" id="privilege" placeholder="Privilege" value="<?php echo $privilege; ?>" />
        </div>
	    <div class="form-group">
