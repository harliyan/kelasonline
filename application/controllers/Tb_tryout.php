...
class Tb_tryout extends CI_Controller
{
    ...
    public function read($id) 
    {
		...
		'nilai' => $row->nilai,
            ...
            $this->load->view('tb_tryout/tb_tryout_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tb_tryout'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('tb_tryout/create_action'),
	    'Id' => set_value('Id'),
	    'kode' => set_value('kode'),
        ...
        $this->load->view('tb_tryout/tb_tryout_form', $data);
    }
